...
function Variables2() {
  ...
  const todasLlantas: Llanta[] = [
    ...
    { id: 9, nombre: '9 - Refuerzo Izquierda', posicion: 'refuerzo', lado: 'izquierda', fp: false, pe: false, pa: false, desgaste: false },
    { id: 10, nombre: '10 - Refuerzo Derecha', posicion: 'refuerzo', lado: 'derecha', fp: false, pe: false, pa: false, desgaste: false }
  ];
